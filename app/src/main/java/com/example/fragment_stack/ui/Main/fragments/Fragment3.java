...
public class Fragment3 extends BaseSupportFragment<BaseMainFrgPresenter> implements IBaseMainFrgContract.IBaseMainFrgView {
    ...
    public void onResume() {
        super.onResume();
        ((MainActivity)getContainerActivity()).updateTitle("Fragment 3");
    }
    ...
    public static Fragment3 newInstance(String data) {
